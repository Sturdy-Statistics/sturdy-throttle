...
(def lib 'com.sturdystats/sturdy-throttle)
...
(defn jar
  ...
  (b/write-pom
   {:class-dir class-dir
    ...
    :src-dirs  ["src"]
    :pom-data
    [[:description "rate limiting for Clojure Ring apps."]
     [:url "https://github.com/Sturdy-Statistics/sturdy-throttle"]
     [:licenses
      [:license
     ...
     [:scm
      ...
      [:url "https://github.com/Sturdy-Statistics/sturdy-throttle"]
      [:connection "scm:git:https://github.com/Sturdy-Statistics/sturdy-throttle.git"]]]})
